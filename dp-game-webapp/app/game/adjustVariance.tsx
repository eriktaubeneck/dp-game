  ...
  return (
    <div className={className}>
      <div className="flex justify-between items-center">
        <button
          className="h-12 w-32 md:w-40 bg-slate-400 dark:bg-slate-600 hover:bg-slate-500 text-white font-bold py-2 px-2 rounded flex items-center justify-between"
